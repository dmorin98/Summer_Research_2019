...
clear all;
clc;
Npp=3;              %Number of point for averaging

X_min = 5;         % Distance for the measurement along x (from -X_min to Xmin)
Y_min = 0;          % Distance for the measurement along y (from -Y_min to Ymin)
Z_min = 3;         % Distance for the measurement along Z (from -Z_min to Zmin)
                    
                
zm=9.3;             % It should be 8.7 for BA11 and WA (9.6 for 2D homog spot)the height of WA1 is 6.4
...
sx=0.1; sy=sx; sz=0.1; % step along x, y and z
