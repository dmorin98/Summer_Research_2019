% mide el campo en 3D,2D,1D . Tiene incluida la corrcci'on del error de la punta y esta optimizado para los imanes chiquitos(jesus)
clear
...
Ysh=0;                  
Zsh=7.15;            %With Zsh=3.69 the botton of the pobe will be 0.7mm over the Array SA1
