...
%   
%   This was last updated Aug 29th 2019 by Devin Morin
%   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if nargin ==0
    ...
    cb(1) = uicontrol('parent',hp(1),'Style', 'check','units','normalized',...
        'String','X','Position',[0 0.5 1/5 .6],'value',0,'fontsize',13,'Callback','MagFieldMeas(1,1)');
    cb(2) = uicontrol('parent',hp(1),'Style', 'check','units','normalized',...
        'String','Y','Position',[2/5 .5 1/5 .6],'value',0,'fontsize',13,'Callback','MagFieldMeas(1,2)');
    ...
    cb(4) = uicontrol('parent',hp(2),'Style', 'check','units','normalized',...
        'String','XY','Position',[0 .8 1/5 .15],'value',1,'fontsize',13,'Callback','MagFieldMeas(2,1)');
    cb(5) = uicontrol('parent',hp(2),'Style', 'check','units','normalized',...
        'String','YZ','Position',[2/5 .8 1/5 .15],'value',0,'fontsize',13,'Callback','MagFieldMeas(2,2)');
    cb(6) = uicontrol('parent',hp(2),'Style', 'check','units','normalized',...
        'String','ZX','Position',[4/5 .8 1/5 .15],'value',0,'fontsize',13,'Callback','MagFieldMeas(2,3)');
    ...
    eb(3) = uicontrol('parent',hp(2),'Style', 'edit','units','normalized',...
        'String','-2','Position',[1/4 .4 1/5 .2],'value',1,'fontsize',13,'Callback','');
    eb(4) = uicontrol('parent',hp(2),'Style', 'edit','units','normalized',...
        'String','2','Position',[3/4 .4 1/5 .2],'value',1,'fontsize',13,'Callback','');
    eb(5) = uicontrol('parent',hp(2),'Style', 'edit','units','normalized',...
        'String','0','Position',[1/4 0.05 1/5 .2],'value',1,'fontsize',13,'Callback','');
    ...
    cb(7) = uicontrol('parent',hp(3),'Style', 'check','units','normalized',...
        'String','X','Position',[4/5 0.6 1/5 .15],'value',0,'fontsize',13,'Callback','MagFieldMeas(3,1)');
    cb(8) = uicontrol('parent',hp(3),'Style', 'check','units','normalized',...
        'String','Y','Position',[4/5 0.4 1/5 .15],'value',0,'fontsize',13,'Callback','MagFieldMeas(3,2)');
    cb(9) = uicontrol('parent',hp(3),'Style', 'check','units','normalized',...
        'String','Z','Position',[4/5 0.2 1/5 .15],'value',1,'fontsize',13,'Callback','MagFieldMeas(3,3)');
    ...
    tb(10) = uicontrol('parent',hp(5),'Style', 'text','units','normalized',...
        'String','Increment(cm)','Position',[0 0.62 0.35 .4],'fontsize',13,'Callback','');
    eb(9) = uicontrol('parent',hp(5),'Style', 'edit','units','normalized',...
        'String','0.1','Position',[0.07 0.5 0.2 .3],'value',1,'fontsize',13,'Callback','');
    ...
    tb(8) = uicontrol('parent',hp(5),'Style', 'text','units','normalized',...
        'String','Averages','Position',[1/3 .8 1/3 .22],'fontsize',13,'Callback','');
    eb(8) = uicontrol('parent',hp(5),'Style', 'edit','units','normalized',...
        'String','1','Position',[0.4 .5 1/5 .3],'value',1,'fontsize',13,'Callback','');
...
if nargin == 1 && o1 == 2
    xyE = 0.208;  %xyE is half the width of the probe tip (cm)
    zE = 0.18;    %zE is the length from sensitive area to probe tip on Z(cm)
