...
% All the data and the date of the measurement is saved automatically to FieldMeas.mat     %
...
sz = 0.1;
zm=7.5;                    % It should be 7.5 for BA11 and WA
Z = -Z_min:sz:Z_min;
dpe=[0:sz:pe]; ldpe=length(dpe);


Npp=20;                    % Number of points for average 
movem(s2,3,-50);
...
stop_gauss
 ...
 time=clock;
 save FieldMeas f fx fy fz Z time